...
import { Orbit, Mail, Lock, ArrowRight, Github } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        // Here we could also save the user's name to a Firestore profile document
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                ...
                className="w-full flex justify-center py-2 px-4 border border-slate-700 rounded-md shadow-sm bg-slate-900/50 text-sm font-medium text-slate-300 hover:bg-slate-800 transition-colors"
              >
              ...
              <button
                type="button"
                className="w-full inline-flex justify-center flex items-center justify-center py-2 px-4 border border-slate-700 rounded-md shadow-sm bg-slate-900/50 text-sm font-medium text-slate-300 hover:bg-slate-800 transition-colors"
              >
